...
"""
https://github.com/EPFL-VILAB/omnidata/blob/main/omnidata_tools/torch/losses/virtual_normal_loss.py
"""
...
class VNL_Loss(nn.Module):
    ...
    def select_index(self):
        ...
        p1_y = (p1 / self.input_size[1])

        p2_x = p2 % self.input_size[1]
        p2_y = (p2 / self.input_size[1])

        p3_x = p3 % self.input_size[1]
        p3_y = (p3 / self.input_size[1])
...
if __name__ == '__main__':
    import cv2
    vnl_loss = VNL_Loss(9.5080e-01, 1.3241e+00,(518, 518))
